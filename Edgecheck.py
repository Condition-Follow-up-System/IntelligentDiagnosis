...
# 第一步：完成高斯平滑滤波
img = cv2.imread("C:/began.jfif", 0)
sobel = cv2.Canny(img, 50, 100)
cv2.namedWindow('5', 0)
cv2.resizeWindow("5", 420, 380)
...
cv2.namedWindow('1', 0)
cv2.resizeWindow("1", 420, 380)
cv2.namedWindow('2', 0)
cv2.resizeWindow("2", 420, 380)
cv2.namedWindow('3', 0)
cv2.resizeWindow("3", 420, 380)
cv2.namedWindow('4', 0)
cv2.resizeWindow("4", 420, 380)
...
plt.subplot(152),plt.imshow(img1)
plt.title("梯度幅值图"),plt.xticks([]),plt.yticks([])
plt.subplot(153),plt.imshow(img2)
plt.title("非极大值抑制灰度图"),plt.xticks([]),plt.yticks([])
plt.subplot(154),plt.imshow(sobel)
plt.title("角度值灰度图"),plt.xticks([]),plt.yticks([])
plt.subplot(155),plt.imshow(img3)
plt.title("最终效果图"),plt.xticks([]),plt.yticks([])
plt.show()'''
